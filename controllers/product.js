...
const getProducts = (req, res) => {
    ...
    const query = 'SELECT products.product_id, products.name AS product_name, products.unit_price, products.total_quantity, materials.name AS material_name, products.material_quantity, products.material_id FROM products LEFT JOIN materials ON products.material_id = materials.material_id';
...
const createProduct = (req, res) => {
    ...
    const query = 'INSERT INTO products (name, unit_price, total_quantity, material_id, material_quantity) VALUES (?, ?, ?, ?, ?)';
